    ...
    return (
      <div>
        <Table
          ...
          useHeadline
          skeletonRow={5}
          createTitle="Tambah Mahasiswa"
          title="Management Mahasiswa"
          description="Tambahkan semua mahasiswa yang terdaftar"
          ...
          create={() =>
            this.props.navigate(
              "/master/mahasiswa/" + this.props.params?.periodeId + "/create"
            )
          }
          edit={(row) =>
            this.props.navigate(
          ...
          onBack={() => this.props.navigate("/master/mahasiswa")}
          extraHeader={
            <div className="my-4">
                ...
                <div className="w-fit text-xs ">
                  ...
                  <div className="grid grid-cols-2 gap-x-3 w-fit">
                    ...
                    <span className=" font-intermedium">
                      {
                        this.state.periodeIndex?.response_data?.mahasiswa
                          ?.length
                      }{" "}
                      Mahasiswa
                    </span>
