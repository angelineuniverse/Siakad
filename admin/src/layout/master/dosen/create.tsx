    ...
    return (
      <div>
        <div className="flex gap-x-5 mb-12">
          <div
            onClick={() => this.props.navigate("/master/dosen")}
            aria-hidden="true"
          ...
          <div>
            ...
            <p className=" font-interregular text-xs">
              {!this.state.isCreate
                ...
                : "Detail informasi dosen dapat anda lihat dibawah ini"}
            </p>
          </div>
        </div>
        <Suspense>
        ...
        <div className="my-8">
          ...
          <ul className=" list-inside list-decimal font-interregular text-xs mt-3">
            ...
            <li>Masukan alamat tinggal dengan lengkap dan benar</li>
          </ul>
        </div>
        <Suspense>
          <Checkbox
          ...
          <Button
            ...
            title={!this.state.isCreate ? "Tambah Dosen" : "Update Dosen"}
            theme="primary"
            size="medium"
