...
import { ModelPagination } from "./model.ts";
import { paginateController, dots } from "./controller.ts";
const Icon = React.lazy(() => import("../icon/icon.tsx"));
...
class Pagination extends Component<ModelPagination> {
  ...
  componentDidUpdate(prevProps): void {
    console.log(this.props.totalPage, prevProps.totalPage);
  ...
  classpaginatePage(index, currentPage) {
