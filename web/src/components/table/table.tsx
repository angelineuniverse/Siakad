...
const Button = React.lazy(() => import("../button/button.tsx"));
const Skeleton = React.lazy(() => import("../skeleton/skeleton.tsx"));
const Pagination = React.lazy(() => import("../pagination/pagination.tsx"));
